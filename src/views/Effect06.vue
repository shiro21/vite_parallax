        ...
        scrollProgress() {
            ...
            for(let i = 1; i <= sectionId; i++) {
                if(scrollTop > document.getElementById("article" + i).offsetTop) {
                    document.getElementById("article" + i).classList.add("effect_show")
                    document.getElementById("article" + i).classList.remove("effect_hide")
                } else {
                    document.getElementById("article" + i).classList.remove("effect_show")
                    document.getElementById("article" + i).classList.add("effect_hide")
                }
            } 
        }
    }
